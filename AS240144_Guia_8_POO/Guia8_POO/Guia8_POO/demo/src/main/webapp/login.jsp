        ...
        <div id="login-box" class="col-md-12">
          <form id="login-form" class="form" action="GeneraSession" method="post">
            ...
            <div class="form-group">
              ...
              <!-- El ID aquí se mantiene como 'password' -->
            ...
            <div id="register-link" class="text-right">
              <a style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#exampleModal" class="text-info">Regístrese aquí</a>
            </div>
          </form>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form id="save-form" class="form" action="RegistrarPersona" method="post">
                    ...
                    <div class="form-group">
                      <label for="password-registro" class="text-info">Password:</label><br>
                      <!-- Cambié el ID a 'password-registro' para que sea único -->
                      <input type="password" name="password" id="password-registro" class="form-control">
                    </div>
                  </form>
                </div>
                <div class="modal-footer">
                  <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                  <!-- Cambié 'saveform' por 'save-form' -->
